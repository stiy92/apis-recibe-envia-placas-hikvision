...
function agregarCamara(placa, fecha) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (canti == 6 && filtro.test(placa)) {
            ...
            let pool = yield sqll.connect(con);
            yield pool.request().query(query, function (err, result, filed) {
                if (err)
                    throw err;
                //console.log(result);
            ...
            let pool2 = yield sqll.connect(con);
            yield pool2.request().query(query2, function (err, result, filed) {
                if (err)
                    throw err;
                //console.log(result);
